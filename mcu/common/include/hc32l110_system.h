...
extern uint32_t core_system_clock_frequency;          // System Clock Frequency (Core Clock)
extern void core_system_init (void);            // Initialize the system
extern void core_system_clock_frequency_update (void); // Update core_system_clock_frequency variable
