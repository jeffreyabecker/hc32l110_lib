...
if(HC32_USE_DDL_TIMERS)
   link_libraries("hc32l110_ddl_timers")
...
#endif()
if(HC32_USE_DDL_UTILS)
    link_libraries("hc32l110_ddl_util")
    add_compile_definitions("HC32_USE_DDL_UTILS")
endif()
link_libraries("gcc")
