...
extern const gpio_port_config_t gpio_digital_output_cfg;
extern const gpio_port_config_t gpio_digital_input_cfg;
#define gpio_digital_output (&gpio_digital_output_cfg)
#define gpio_digital_input (&gpio_digital_input_cfg)
