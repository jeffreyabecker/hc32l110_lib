...
{
    HC32_CLOCK->peripheral_clock_enable = (peripheral_t)(HC32_CLOCK->peripheral_clock_enable | peripheral_uart0 | peripheral_basetim);
    ...
    *HC32_GPIO_P36_SEL = port_p36_uart0_rxd;
    ...
    HC32_TIMER0->control_flags.clock_source = (timer_function_t)0;
    HC32_TIMER0->control_flags.mode = (basic_timer_mode_t)1;
    HC32_TIMER0->control_flags.toggle_enabled = 1;
    HC32_TIMER0->auto_reload = 65536 - (system_clock.peripheral_frequency() / (9600 * 32));
