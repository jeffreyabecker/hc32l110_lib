...
// const void GpioPort::configure(const gpio_port_config_t *cfg)
// {
...
const gpio_direction_t GpioPort::direction() { return (gpio_direction_t)((this->_port->DIR & (1 << this->_position))); }
const void GpioPort::direction(gpio_direction_t value) { this->_port->DIR = ((this->_port->DIR & ~(1 << this->_position)) | (value << this->_position)); }
const gpio_analog_digital_t GpioPort::resolution() { return (gpio_analog_digital_t)((this->_port->ADS & (1 << this->_position))); }
const void GpioPort::resolution(gpio_analog_digital_t value) { this->_port->ADS = ((this->_port->ADS & ~(1 << this->_position)) | (value << this->_position)); }
const gpio_drive_capability_t GpioPort::drive_mode() { return (gpio_drive_capability_t)((this->_port->DR & (1 << this->_position))); }
const void GpioPort::drive_mode(gpio_drive_capability_t value) { this->_port->DR = ((this->_port->DR & ~(1 << this->_position)) | (value << this->_position)); }
const gpio_internal_pullup_t GpioPort::pull_up() { return (gpio_internal_pullup_t)((this->_port->PU & (1 << this->_position))); }
const void GpioPort::pull_up(gpio_internal_pullup_t value) { this->_port->PU = ((this->_port->PU & ~(1 << this->_position)) | (value << this->_position)); }
const gpio_internal_pulldown_t GpioPort::pull_down() { return (gpio_internal_pulldown_t)((this->_port->PD & (1 << this->_position))); }
const void GpioPort::pull_down(gpio_internal_pulldown_t value) { this->_port->PD = ((this->_port->PD & ~(1 << this->_position)) | (value << this->_position)); }
const gpio_mode_t GpioPort::gpio_mode() { return (gpio_mode_t)((this->_port->OD & (1 << this->_position))); }
const void GpioPort::gpio_mode(gpio_mode_t value) { this->_port->OD = ((this->_port->OD & ~(1 << this->_position)) | (value << this->_position)); }

const uint8_t GpioPort::function() { return (uint8_t) * (this->_sel); }
const void GpioPort::function(uint8_t value) { *(this->_sel) = value; }

const uint8_t GpioPort::enable_interrupt() { return (uint8_t)nvic_interrupt_enabled(this->_irq); }
const void GpioPort::enable_interrupt(uint8_t value)
{
...
const gpio_interrupt_high_t GpioPort::interrupt_high() { return (gpio_interrupt_high_t)this->_port->HIE; }
const void GpioPort::interrupt_high(gpio_interrupt_high_t value) { this->_port->HIE = value; }
const gpio_interrupt_low_t GpioPort::interrupt_low() { return (gpio_interrupt_low_t)this->_port->LIE; }
const void GpioPort::interrupt_low(gpio_interrupt_low_t value) { this->_port->LIE = value; }
const gpio_interrupt_rising_t GpioPort::interrupt_rising() { return (gpio_interrupt_rising_t)this->_port->RIE; }
const void GpioPort::interrupt_rising(gpio_interrupt_rising_t value) { this->_port->RIE = value; }
const gpio_interrupt_falling_t GpioPort::interrupt_falling() { return (gpio_interrupt_falling_t)this->_port->FIE; }
const void GpioPort::interrupt_falling(gpio_interrupt_falling_t value) { this->_port->FIE = value; }
