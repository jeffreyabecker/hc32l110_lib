...
#define HC32_GPIO_PORT0_INTERRUPT ((gpio_port_interrupt_t *)(GPIO_BASE_ADDRESS + 0x200))
#define HC32_GPIO_PORT1_INTERRUPT ((gpio_port_interrupt_t *)(GPIO_BASE_ADDRESS + 0x240))
#define HC32_GPIO_PORT2_INTERRUPT ((gpio_port_interrupt_t *)(GPIO_BASE_ADDRESS + 0x280))
#define HC32_GPIO_PORT3_INTERRUPT ((gpio_port_interrupt_t *)(GPIO_BASE_ADDRESS + 0x2C0))
